...
const SERVICES = [
  ...
  ['real-estate-consulting', 'Real Estate Consulting', 'Independent advice before you commit capital.', 'Established in 2008, our consulting practice helps buyers, investors and NRIs evaluate micro-markets, verify documentation, understand approvals and time their entry. We are happy to advise against a purchase when the numbers do not work.', 'insights', 5],
