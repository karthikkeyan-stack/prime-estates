...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        'body-sm': ['"Plus Jakarta Sans"', 'Jakarta Fallback', 'system-ui', 'sans-serif'],
        'label-ui': ['"Plus Jakarta Sans"', 'Jakarta Fallback', 'system-ui', 'sans-serif'],
        'body-lg': ['"Plus Jakarta Sans"', 'Jakarta Fallback', 'system-ui', 'sans-serif'],
        'metric-price': ['"Plus Jakarta Sans"', 'Jakarta Fallback', 'system-ui', 'sans-serif'],
        'body-md': ['"Plus Jakarta Sans"', 'Jakarta Fallback', 'system-ui', 'sans-serif'],
        'headline-lg-mobile': ['"Playfair Display"', 'Playfair Fallback', 'Georgia', 'serif'],
        'display-hero': ['"Playfair Display"', 'Playfair Fallback', 'Georgia', 'serif'],
        'headline-sm': ['"Playfair Display"', 'Playfair Fallback', 'Georgia', 'serif'],
        'title-md': ['"Plus Jakarta Sans"', 'Jakarta Fallback', 'system-ui', 'sans-serif'],
        'title-lg': ['"Plus Jakarta Sans"', 'Jakarta Fallback', 'system-ui', 'sans-serif'],
        'display-hero-mobile': ['"Playfair Display"', 'Playfair Fallback', 'Georgia', 'serif'],
        'headline-lg': ['"Playfair Display"', 'Playfair Fallback', 'Georgia', 'serif'],
        'headline-md': ['"Playfair Display"', 'Playfair Fallback', 'Georgia', 'serif'],
        'label-caps': ['"Plus Jakarta Sans"', 'Jakarta Fallback', 'system-ui', 'sans-serif'],
      },
      fontSize: {
